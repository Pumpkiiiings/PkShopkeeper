...
public class UnlinkCommand implements Command<CommandSourceStack> {
    ...
    public int run(CommandContext<CommandSourceStack> context) {
        ...
        com.nisovin.shopkeepers.pkshopkeepers.utils.FoliaScheduler.runRegionTask(plugin, shop.getLocation(), () -> {
            new com.nisovin.shopkeepers.pkshopkeepers.entity.ShopEntityListener(plugin, plugin.getShopManager()).spawnShop(shop);
        });
